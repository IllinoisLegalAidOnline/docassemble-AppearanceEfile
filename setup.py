...
setup(name='docassemble.AppearanceEfile',
      ...
      install_requires=['docassemble.ALToolbox @ git+https://github.com/SuffolkLITLab/docassemble-ALToolbox.git@main', 'docassemble.AssemblyLine @ git+https://github.com/SuffolkLITLab/docassemble-AssemblyLine.git@main', 'docassemble.EFSPIntegration @ git+https://github.com/SuffolkLITLab/docassemble-EFSPIntegration.git@main', 'docassemble.ILAOEfile @ git+https://github.com/SuffolkLITLab/docassemble-ILAOEfile.git@main', 'docassemble.PovertyScale>=2024.0.0'],
      zip_safe=False,
